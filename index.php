		...
		<div class="about-me container">
			...
			<div class="row content center">
				<div class="col s12 m4 l4">
					<a href="mailto:jhvndev@gmail.com" class='fa fa-paper-plane-o'>Email</a>
					<br />
					<small>jhvndev@gmail.com</small>
				</div>
				<div class="col s12 m4 l4">
					<a href='skype:jhv_nguyen?call' class='fa fa-skype'>Skype</a>
					<br />
					<small>jhv_nguyen</small>
				</div>
				<div class="col s12 m4 l4">
					<a href="./download/jhvndrev.pdf" class='fa fa-file-pdf-o'>CV</a>
					<br />
					<small>resume</small>					
				</div>
			</div>
